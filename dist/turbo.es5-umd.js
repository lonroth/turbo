...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var RequestInterceptor = (function () {
        ...
        RequestInterceptor.register = function (interceptor) {
            this.interceptor = interceptor;
        };
        RequestInterceptor.get = function () {
    ...
    var FetchRequest = (function () {
        ...
        FetchRequest.prototype.perform = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var requestInterceptor, error_1, fetchOptions, response, error_2;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _c.trys.push([0, 3, , 4]);
                            requestInterceptor = RequestInterceptor.get();
                            if (!requestInterceptor) return [3, 2];
                            return [4, requestInterceptor(this)];
                        case 1:
                            _c.sent();
                            _c.label = 2;
                        case 2: return [3, 4];
                        ...
                        case 8:
                            error_2 = _c.sent();
                            this.delegate.requestErrored(this, error_2);
                            throw error_2;
                        case 9:
        ...
        FetchRequest.prototype.addHeader = function (key, value) {
